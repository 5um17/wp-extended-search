...
class WP_ES_admin {
	...
	public function wp_es_title_content_checkbox(){
        ...
        <input type="hidden" name="wp_es_options[admin]" value="0" />
        <input <?php checked($settings['admin']); ?> type="checkbox" id="esadmin" name="wp_es_options[admin]" value="1" />&nbsp;
        <label for="esadmin"><?php _e('Allow Search in Admin Area', 'wp-extended-search'); ?></label>
        <br />
