...
class WPES_Search_Widget extends WP_Widget {
	...
	public function form( $instance ) {
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'title' ); ?>"><?php _e( 'Title:', 'wp-extended-search' ); ?></label>
		...
		?>
		<p>
			<label for="<?php echo $this->get_field_id( 'wpessid' ); ?>"><?php _e( 'Setting Name:', 'wp-extended-search' ); ?></label>
